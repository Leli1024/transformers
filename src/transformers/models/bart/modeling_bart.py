...
from ...generation_utils import GreedySearchEncoderDecoderOutput, GreedySearchDecoderOnlyOutput, SampleDecoderOnlyOutput, SampleEncoderDecoderOutput, BeamSearchEncoderDecoderOutput, BeamSearchDecoderOnlyOutput, BeamSampleEncoderDecoderOutput, BeamSampleDecoderOnlyOutput, BeamSearchScorer, DisjunctiveConstraint, PhrasalConstraint, ConstrainedBeamSearchScorer
from ...generation_utils import LogitsProcessorList, StoppingCriteriaList, Constraint
...
class BartForConditionalGeneration(BartPretrainedModel):
    ...
    def generate(
        ...
        blurred_inputs: Optional[torch.Tensor] = None,
    ...
    def greedy_search(
        ...
        blurred_input_ids: Optional[torch.LongTensor] = None,
        ...
        **model_kwargs,
        ...
        while True:
            ...
            blurred_model_inputs = None
            
            if (blurred_input_ids is not None):
                blurred_model_inputs = self.prepare_inputs_for_generation(blurred_input_ids, **model_kwargs)
            

            # forward pass to get next token
            outputs = self(
                **model_inputs,
                blurred_model_inputs = blurred_model_inputs,
                return_dict=True,
                output_attentions=output_attentions,
                output_hidden_states=output_hidden_states,
            )
    ...
    def sample(
        self,
        input_ids: torch.LongTensor,
        blurred_inputs: torch.LongTensor = None,
        logits_processor: Optional[LogitsProcessorList] = None,
        stopping_criteria: Optional[StoppingCriteriaList] = None,
